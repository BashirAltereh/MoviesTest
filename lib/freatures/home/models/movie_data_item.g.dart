...
part of 'movie_data_item.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MovieDataItemAdapter extends TypeAdapter<MovieDataItem> {
  @override
  final int typeId = 1;

  @override
  MovieDataItem read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MovieDataItem obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj._adult)
