    ...
    return BlocBuilder<ThemeCubit, ThemeState>(
        ...
        builder: (context, state) {
          return Row(
            ...
            children: [
              Tooltip(
                message: themeCubit.themeMode == ThemeMode.dark ? 'set_light_theme'.tr() : 'set_dark_theme'.tr(),
                child: CupertinoButton(
                    child: Icon(themeCubit.themeMode == ThemeMode.dark ? Icons.ac_unit : Icons.mode_night_sharp,
                        color: Theme.of(context).colorScheme.primaryContainer),
                    onPressed: () {
                      themeCubit.setTheme(themeCubit.themeMode == ThemeMode.dark ? ThemeMode.light : ThemeMode.dark);
                    }),
              ),
            ],
          );
